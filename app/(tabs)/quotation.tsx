...
const RelationshipCard = ({ item, index }: { item: any; index: number }) => {
  return (
    <Animated.View
        ...
        <View className="bg-[#18181b] rounded-2xl overflow-hidden">
          <View className="p-4">
            ...
            <View className="mb-4">
              ...
              {/* <Text
                className="text-gray-400 my-1 text-sm"
              ...
              <View className="flex flex-row space-x-2 my-2 items-center">
                <FontAwesome name="building-o" size={20} color="white" />
                <Text className="text-gray-400  text-sm" fontFamily="KumbhSans">
                  #Reference <Text fontFamily="KumbhSans-Bold">{item?.clientReference}</Text>
                </Text>
              </View>
            </View>
    ...
    <View className="flex-1 bg-black" style={{ paddingTop: insets.top }}>
      ...
      >
        <View className="flex-row justify-between items-center mb-4">
          ...
          <Pressable
            onPress={() => router.navigate("/add-relationship")}
      ...
      <FlatList
        ...
        renderItem={({ item, index }) => (
          <RelationshipCard item={item} index={index} />
        )}
